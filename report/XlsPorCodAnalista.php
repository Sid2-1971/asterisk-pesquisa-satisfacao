...
$cod_analista = $_GET['cod_analista'];
...
//query de consulta
$result = mysql_query("SELECT * FROM $base.$tabela_pesquisa WHERE codigo_analista = '$cod_analista'");
...
$arquivo = "Relatorio_Pesquisa_$cod_analista.xls";  
