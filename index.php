...
<?php
     ...
     */
    $LIMITE = 10;
    $SQL_COUNT = $CONEXAO->query( "SELECT id FROM $base.$tabela_pesquisa" );
    $SQL_RESUL = ceil($SQL_COUNT->num_rows / $LIMITE);
    $pg = (isset($_GET["pg"])) ? (int)$_GET["pg"] : 1 ;
    $START = ($pg - 1) * $LIMITE;
    $resultado = $CONEXAO->query("SELECT * FROM $base.$tabela_pesquisa  LIMIT $START, $LIMITE");
    ...
    echo "    <li>";
    echo "      <a href='?pg=1' aria-label='Previous'>";
    ...
    echo "    <li>";
    echo "      <a href='?pg=$SQL_RESUL' aria-label='Next'>";
